...
All annan data även kallat **cookies** avstår **DIS** från att samla in.
...
**Departementet för Internetservice** kan nås alla dagar, oftast dagtid
och svar kan dröja. All kontakt som inte berör *programmering* uppskattas
om den ses över och eventuellt inte skickas.

```bash
carlalvinelias@gmail.com
Munkfors, 684 31
Gjutaregatan 20
```

<img className="rounded-md" src="/Logo%20-%20DIS.png" alt="Departementet för Internetservice">
